...
const BusStop = ({ position, stopName, lineColor = "#ff0000" }) => {
  ...
  const customMarker = L.divIcon({
    ...
    iconAnchor: [12, 24],
    popupAnchor: [0, -24],
    html: `<i style="background-color: ${lineColor}88; outline-color: ${lineColor}" className="w-6 aspect-square rounded-full text-white outline-2 grid place-items-center fi fi-rr-bus-alt"></i>`,
  });
